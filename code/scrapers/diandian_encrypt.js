...
function get_kk(params,data) {
    path = "/v2/word/search_related_contents"
    we.params = params
    var r = we.params
        , o = _(r, path, data, "get");
    return o
...
function gen_search_k(params,data) {
    path = "/v2/word/search"
    we.params = params
    var r = we.params
        , o = _(r, path, data, "get");
